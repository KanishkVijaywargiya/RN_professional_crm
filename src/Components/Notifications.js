    ...
    render() {
        return (
            <AnimatedContainer style={{ top: this.state.top }}>
                ...
                <View style={{ position: 'absolute', zIndex: 100, width: hp('44%'), flexDirection: 'row', backgroundColor: 'white', elevation: 10, shadowColor: 'rgba(191, 223, 237, 1)', shadowOpacity: 1, shadowRadius: 2, shadowOffset: { width: 2, height: 5 }, alignItems: 'center', height: 50, borderRadius: 25, marginTop: hp('13%'), marginLeft: hp('1%'), marginRight: hp('1%') }}>
                    <TextInput
                        placeholder='Search by Service Name'
                        placeholderTextColor="#BFDFED"
                        onChangeText={text => this.searchFilterFunction(text)}
                        style={{ flex: 1, fontSize: 20, fontWeight: "bold", marginLeft: hp('2%'), height: 45, color: '#121212', alignItems: 'center' }}
                    />
                    <Icon style={{ marginRight: hp('2%') }}
                        name={'ios-search'}
                        color={'#121212'}
                ...
                <SafeAreaView>
                    <ScrollView style={{ marginTop: hp('10%') }}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center', bottom: hp('2%') }}>
                            <Text style={{ color: '#121212', fontSize: 10, fontStyle: 'italic' }}>BlaceNova Inc.<Text style={{ color: '#121212', fontSize: 10, lineHeight: 50, fontStyle: 'italic' }}>TM</Text></Text>
                        </View>
                    </ScrollView>
                </SafeAreaView>
            </AnimatedContainer>
...
const items = [
    {
        logo: "https://p73.f4.n0.cdn.getcloudapp.com/items/wbu7xK6X/logo-vue.png?v=2f6cbfbd65c9698f25db8b6a2d8d7700",
