                ...
                <KeyboardAwareScrollView>
                    <SafeAreaView>
                        ...
                        <View style={{ alignItems: 'center', marginTop: Platform.OS === 'ios' ? hp('5%') : hp('0.5%') }}>
                            ...
                            <Text style={{ fontSize: 12, fontWeight: '500', color: '#121212' }}>Please type your email id to reset password </Text>
                        </View>
                        ...
                        <View style={[styles.uploadButton]}>
                            <TouchableOpacity onPress={() => this.onResetPasswordPress()}>
                                <View style={[styles.textView]}>
                                    <Text style={{ color: '#fff', fontSize: 22, fontWeight: 'bold' }}>Reset Password</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                    </SafeAreaView>
