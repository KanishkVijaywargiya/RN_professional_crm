                ...
                <KeyboardAwareScrollView>
                    <SafeAreaView>
                        ...
                        <View style={{ alignItems: 'center', marginTop: Platform.OS === 'ios' ? hp('5%') : hp('0.5%') }}>
                            ...
                            <Text style={{ fontSize: 12, fontWeight: '500', color: '#121212' }}>Log in to your existed account of Clean & Shine CRM</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Platform.OS === 'ios' ? hp('3%') : hp('3%'), height: Platform.OS === 'ios' ? hp('6.5%') : hp('8%'), borderRadius: 30, borderWidth: 1, borderColor: '#3498DB', alignSelf: 'center', width: Dimensions.get('window').width - 30 }}>
                            <View style={{ flex: 0.2, alignItems: 'center' }}>
                                <IconEmail source={this.state.IconEmail} />
                            </View>
                            <TextInput style={{ flex: 0.8, fontSize: 22, color: '#3498DB' }}
                                autocapitalize='none'
                                placeholder='Email'
                        ...
                        <View style={{ alignSelf: 'center', alignItems: 'center', justifyContent: 'center', marginTop: Platform.OS === 'ios' ? hp('5%') : hp('3%'), height: 50, width: Dimensions.get('window').width }}>
                            <TouchableOpacity onPress={() => this.onSignIn()}>
                                <View style={{ alignSelf: 'center', alignItems: 'center', justifyContent: 'center', backgroundColor: '#3498DB', height: 50, borderRadius: 25, borderWidth: 1, borderColor: '#3498DB', width: Dimensions.get('window').width - 250, shadowColor: '#3498DB', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.8, shadowRadius: 2, elevation: 1 }}>
                        ...
                        {Platform.OS === 'android' ?
                            <View style={{ alignItems: 'center', paddingLeft: 20, flexDirection: 'row', justifyContent: 'center', bottom: 2, marginTop: hp('1%') }}>
                                ...
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('SignUp')}>
                                    <Text style={{ color: '#3498DB', fontSize: 16, fontWeight: '700' }}>Sign Up</Text>
                                </TouchableOpacity>
                            </View>
                            :
                            null
